...
const BUILTIN_PACKS = [{
    ...
    ident: "Jarvis's Orientation",
    title: "Jarvis's Orientation (WIP)",
    desc: "Your first days in service — a gentle tour of the household's puzzles, one duty at a time. Start here.",
}, {
