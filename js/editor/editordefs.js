...
export const TOOLS = {
    ...
    line: {
        ...
        name: "Line",
        desc: [
            "Draw lines using the foreground tile.",
            "Picks the top-most tile by default.",
            "Use the layer selector to pick specific tiles.",
            "",
            "[mouse1] Draw a line",
    ...
    box: {
        ...
        name: "Box",
        desc: [
            "Draw rectangles using the foreground tile.",
            "Picks the top-most tile by default.",
            "Use the layer selector to pick specific tiles.",
            "",
            "[mouse1] Draw a rectangle",
            "[shift] [mouse1] Draw a square",
            "[ctrl] [mouse1] Draw a filled rectangle",
            "",
            "[mouse2] Pick foreground tile",
            "[ctrl] [mouse2] Pick background tile",
        ].join("\n"),
        ...
        uses_layers: undefined,
        shortcut: 'u',
        op1: mouseops.RectangleOperation,
        op2: mouseops.EyedropOperation,
    },
    fill: {
